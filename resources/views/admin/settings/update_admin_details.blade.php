                        ...
                        <div class="card-body">
                            ...
                            <form class="forms-sample" action="{{ url('admin/update-admin-details') }}" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="admin_first_name"
                                        value="{{ Auth::guard('admin')->user()->first_name }}" name ="admin_first_name"
                                        required="">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="admin_mobile" name ="admin_mobile"
                                        value="{{ Auth::guard('admin')->user()->mobile }}" required="" maxlength="10"
                                        minlength="10">
                                </div>
                                <div class="form-group">
