                ...
                <div class="col-md-12 grid-margin">
                    <div class="row">
                        <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                            <h3 class="font-weight-bold">Edit Perent</h3>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="forms-sample" action="{{ url('admin/edit-parent/' . $parent['id']) }}"
                                ...
                                <div class="form-group">
                                    <label for="parent_profession">Profession</label>
                                    <input type="text" class="form-control" id="parent_profession"
                                        name ="parent_profession" value="{{ $parent['profession'] }}" required="">
                                </div>
